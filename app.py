...
def app_deploy(plopper_df):
    ...
    src_port_df['Source Port'] = src_port_df['Source Port'].astype(str)
    ...
    dest_port_df['Destination Port'] = dest_port_df['Destination Port'].astype(str)
    ...
    unique_ips = plopper_df['Destination IP'].nunique()

    count_of_events = plopper_df['Event'].nunique()

    count_of_classes = plopper_df['Classification'].nunique()
        ...
        dbc.Row([
            dbc.Col([
                ...
                dt.DataTable(
                    ...
                    data=plopper_df.to_dict(orient='records'),
                )
            ], width=12)
        ]),
    ])
